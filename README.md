...
## Stack version
  ...
  - Kafka version: 2.6.0 (Confluent 6.0.0)
  - Kafka Schema Registry: Confluent 6.0.0
  - Kafka Schema Registry UI: 0.9.5
  - Kafka Rest Proxy: Confluent 6.0.0
  - Kafka Topics UI: 0.9.4
  - Kafka Connect: Confluent 6.0.0
  - Kafka Connect UI: 0.9.7
  - ksqlDB Server: Confluent 6.0.0
  - Zoonavigator: 0.8.0
